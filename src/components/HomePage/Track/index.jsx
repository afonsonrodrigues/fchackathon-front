    ...
    return (
        <div>
            <HashLink className='w-[344px] h-[263px]' smooth='true' timeout={1000} scroll={el => scrollWithOffset(el)} to='/home#track-card'>
                <TrackWrapper onClick={handleSetCurrentTrack} className='w-[358px] h-[278px] sm:w-[344px] sm:h-[263px] lg:w-[384px] lg:h-[278px] pt-14 pb-8  flex flex-col items-center justify-between'>
