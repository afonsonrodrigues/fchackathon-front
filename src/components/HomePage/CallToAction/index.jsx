...
export default function CallToAction() {
    ...
    return (
        <CallToActionContainer className='flex flex-col items-center px-4 mt-28 sm:mt-[120px] sm:px-16 lg:w-[622px] lg:mt-32'>
            ...
            <HashLink className='h-[56px] mb-[78px] sm:mb-[78px] lg:mb-[102px]' smooth='true' timeout={1000} scroll={el => scrollWithOffset(el)} to="/home#tracks-list">
