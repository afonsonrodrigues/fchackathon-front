        ...
        <DisclaimerContainer className="my-0 mx-auto flex flex-col lg:w-[960px] xl:w-[1280px]">
            <div className="flex flex-col py-6 px-3 sm:px-8 items-center lg:flex-row lg:justify-between">
                <TextWrapper className="flex flex-col mb-8 lg:w-[622px]">
                    ...
                    <Text className="mb-[12px]">{disclaimer.part1}</Text>
                    <Text className="hidden sm:block">{disclaimer.part2}</Text>
                </TextWrapper>
                <CustomButton
                    onClick={handleSignToTrack}
                    className="h-[52px] w-[181px] call-button lg:self-start lg:mr-6 lg:mt-6"
                >
                    Iniciar trilha
                </CustomButton>
            </div>
            <Title className="text-center font-semibold mb-2">Quem apoia</Title>
            <div className="flex flex-wrap p-6 mb-8 items-center gap-y-4 justify-between lg:justify-center lg:gap-10 xl:gap-12">
                <img
                    className="h-[40px] lg:h-[48px] xl:h-[56px]"
                    src={FCamaraLogo}
                    alt="fcamara's logo"
                />
                <img
                ...
                />
                <img
                    className="h-[32px] lg:h-[48px] xl:h-[56px]"
                    src={RocketLogo}
                    alt="rocketseat's logo"
                />
                <img
                    className="h-[40px] lg:h-[48px] xl:h-[56px]"
                    src={CubosLogo}
