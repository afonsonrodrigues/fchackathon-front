...
export default function TrackRow({ track, handleGetAllTracksNContent, setEditModal, editModal }) {
        ...
        <>
            <tr className='h-10 cursor-pointer'>
                ...
                <td className='flex justify-center py-4 gap-3 relative'>
                    <Pencil className='hover:scale-105 cursor-pointer' onClick={(e) => setEditModal({ ...editModal, open: true, track_id: track.id })} color='#0C16BB'
                        size={24} />
